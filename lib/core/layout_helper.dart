    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth < mobileWidth) {
          return HomepageMobile(platformWidth: constraints.maxWidth, platformHeight: constraints.maxHeight);
        } else {
          return HomepageDesktop(platformWidth: constraints.maxWidth, platformHeight: constraints.maxHeight);
        }
      },
    );
  }
